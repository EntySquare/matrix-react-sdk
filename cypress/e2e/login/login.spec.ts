...
describe("Login", () => {
    ...
    describe("logout", () => {
        ...
        it("should respect logout_redirect_url", () => {
            cy.tweakConfig({
                // We redirect to decoder-ring because it's a predictable page that isn't Redleaves itself.
                ...
                // `test-landing.html` page when running with an uncontrolled Redleaves (via `yarn start`).
